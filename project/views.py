...
def delete_user(request, project_user_id):
  projectuser = get_object_or_404(ProjectUser, project_user_id=project_user_id)

  projectuser.delete()

  messages.success(request, f'{projectuser.project_user} deleted and will no longer have access to the Project')
